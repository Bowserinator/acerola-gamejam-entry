...
void main() {
    ...
    vec4 sample1 = texture2D(texture0, fragTexCoord + vec2(offset * 0.1));
    vec4 sample2 = texture2D(texture0, fragTexCoord + vec2(offset * 0.11));
    vec4 sample3 = texture2D(texture0, fragTexCoord + vec2(offset * 0.12));
